    ...
    def validate(self, value):
        if value is not None and not isinstance(value, Flow):
            raise db.BadValueError(
                ...
                "to a FlowThreeLegged instance (%s)" % (self.name, value)
            )
...
if ndb is not None:
    ...
    """
      ...
      """
            ...
            if value is not None and not isinstance(value, Flow):
                raise TypeError(
                    "Property %s must be convertible to a flow "
  ...
  """
    ...
    def validate(self, value):
        ...
        if value is not None and not isinstance(value, Credentials):
            raise db.BadValueError(
                "Property %s must be convertible "
                "to a Credentials instance (%s)" % (self.name, value)
            )
        # if value is not None and not isinstance(value, Credentials):
        #  return None
        return value
...
if ndb is not None:
    ...
    """
      ...
      """
            ...
            if value is not None and not isinstance(value, Credentials):
                raise TypeError(
                    "Property %s must be convertible to a credentials "
                    "instance; received: %s." % (self._name, value)
                )
